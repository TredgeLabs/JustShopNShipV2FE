export const countries = [
  ...
  { code: 'CA', name: 'Canada', phoneCode: '+1', flag: '🇨🇦', popular: true },
  { code: 'GB', name: 'United Kingdom', phoneCode: '+44', flag: '🇬🇧', popular: true },
  { code: 'AU', name: 'Australia', phoneCode: '+61', flag: '🇦🇺', popular: true },
  { code: 'DE', name: 'Germany', phoneCode: '+49', flag: '🇩🇪', popular: true },
  { code: 'AE', name: 'United Arab Emirates', phoneCode: '+971', flag: '🇦🇪', popular: true },
  { code: 'SG', name: 'Singapore', phoneCode: '+65', flag: '🇸🇬', popular: false },
  { code: 'FR', name: 'France', phoneCode: '+33', flag: '🇫🇷', popular: false },
  { code: 'JP', name: 'Japan', phoneCode: '+81', flag: '🇯🇵', popular: false },
  { code: 'IN', name: 'India', phoneCode: '+91', flag: '🇮🇳', popular: false },
